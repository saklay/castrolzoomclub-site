...
<table class="forumborder" width="100%" cellpadding="4" cellspacing="1" border="0">
        <tr> 
                <th class="forumtitle" colspan="4">{L_SEARCH_QUERY}</th>
        </tr>
        <tr> 
        ...
        <tr> 
                <th class="menu" colspan="4" height="25">{L_SEARCH_OPTIONS}</th>
        </tr>
        <tr> 
        ...
        <tr> 
                <td class="menu" colspan="4" align="center" height="28">{S_HIDDEN_FIELDS}<input class="liteoption" type="submit" value="{L_SEARCH}" /></td>
        </tr>
</table>
