...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumborder">
  <tr> 
        <th class="forumtitle">{L_IP_INFO}</th>
  </tr>
  <tr> 
        <td class="menu" height="28"><span class="cattitle"><b>{L_THIS_POST_IP}</b></span></td>
  </tr>
  <tr> 
        <td class="row1"> 
  ...
  <tr> 
        <td class="menu" height="28"><span class="cattitle"><b>{L_OTHER_USERS}</b></span></td>
  </tr>
  <!-- BEGIN userrow -->
  <tr> 
  ...
  <!-- END userrow -->
  <tr> 
        <td class="menu" height="28"><span class="cattitle"><b>{L_OTHER_IPS}</b></span></td>
  </tr>
  <!-- BEGIN iprow -->
  <tr> 
