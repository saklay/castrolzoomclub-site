...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumborder">
        <tr> 
          <td class="forumtitle" colspan="5" align="center"><span class="cattitle">{L_MOD_CP}</span>
          </td>
        </tr>
        <tr> 
        ...
        <tr> 
          <th width="4%" class="menu" nowrap="nowrap">&nbsp;</th>
          <th class="menu" nowrap="nowrap">&nbsp;{L_TOPICS}&nbsp;</th>
          <th width="8%" class="menu" nowrap="nowrap">&nbsp;{L_REPLIES}&nbsp;</th>
          <th width="17%" class="menu" nowrap="nowrap">&nbsp;{L_LASTPOST}&nbsp;</th>
          <th width="5%" class="menu" nowrap="nowrap">&nbsp;{L_SELECT}&nbsp;</th>
        </tr>
        <!-- BEGIN topicrow -->
        <tr> 
        ...
        <!-- END topicrow -->
        <tr align="right"> 
          <td class="menu" colspan="5" height="29"> {S_HIDDEN_FIELDS}
