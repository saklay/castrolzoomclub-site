...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumborder" align="center">
  <tr> 
        <th width="4%" class="forumtitle" nowrap="nowrap">&nbsp;</th>
        <th class="forumtitle" nowrap="nowrap">&nbsp;{L_FORUM}&nbsp;</th>
        <th class="forumtitle" nowrap="nowrap">&nbsp;{L_TOPICS}&nbsp;</th>
        <th class="forumtitle" nowrap="nowrap">&nbsp;{L_AUTHOR}&nbsp;</th>
        <th class="forumtitle" nowrap="nowrap">&nbsp;{L_REPLIES}&nbsp;</th>
        <th class="forumtitle" nowrap="nowrap">&nbsp;{L_VIEWS}&nbsp;</th>
        <th class="forumtitle" nowrap="nowrap">&nbsp;{L_LASTPOST}&nbsp;</th>
  </tr>
  <!-- BEGIN searchresults -->
  <tr> 
  ...
  <!-- END searchresults -->
  <tr> 
        <td class="menu" colspan="7" height="28" valign="middle">&nbsp; </td>
  </tr>
</table>
