...
<table class="forumborder" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  <tr> 
        <th class="forumtitle" colspan="2" nowrap="nowrap">{L_VIEWING_PROFILE}</th>
  </tr>
  <tr> 
        <th class="menu" width="40%" align="center"><b><span class="gen">{L_AVATAR}</span></b></td>
        <td class="menu" width="60%"><b><span class="gen">{L_ABOUT_USER}</span></b></td>
  </tr>
  <tr> 
  ...
  <tr> 
        <th class="menu" align="center" height="28"><b><span class="gen">{L_CONTACT} {USERNAME} </span></b></td>
  </tr>
  <tr> 
