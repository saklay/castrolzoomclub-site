...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumborder">
        <tr> 
                <th class="forumtitle" colspan="2" valign="middle">{L_REGISTRATION_INFO}</th>
        </tr>
        <tr> 
        ...
        <tr> 
          <th class="forumtitle" colspan="2" valign="middle">{L_PROFILE_INFO}</th>
        </tr>
        <tr> 
        ...
        <tr> 
          <th class="forumtitle" colspan="2" valign="middle">{L_PREFERENCES}</th>
        </tr>
        <tr> 
        ...
        <tr> 
          <th class="forumtitle" colspan="2" valign="middle">{L_AVATAR_PANEL}</th>
        </tr>
        <tr> 
        ...
        <tr>
                <td class="menu" colspan="2" align="center" height="28">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="liteoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" /></td>
        </tr>
</table>
