...
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
        <tr> 
          <td align="left" valign="bottom" colspan="2"><div class="small"><a href="{U_VIEW_FORUM}"><span class="topictitle1">{FORUM_NAME}</span></a><br />{L_MODERATOR}: {MODERATORS}<br />{LOGGED_IN_USER_LIST}</div></td>
  ...
  <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumborder">
        ...
        <tr> 
          <td class="menu" align="center" valign="middle" colspan="6"><span class="genmed">{L_DISPLAY_TOPICS}:&nbsp;{S_SELECT_TOPIC_DAYS}&nbsp;
