...
<table class="forumborder" width="100%" cellspacing="1" cellpadding="4" border="0">
        <tr> 
                <th class="forumtitle" colspan="7">{L_GROUP_INFORMATION}</th>
        </tr>
        <tr> 
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumborder">
        <tr> 
          <th class="forumtitle">{L_PM}</th>
          <th class="forumtitle">{L_USERNAME}</th>
          <th class="forumtitle">{L_POSTS}</th>
          <th class="forumtitle">{L_FROM}</th>
          <th class="forumtitle">{L_EMAIL}</th>
          <th class="forumtitle">{L_WEBSITE}</th>
          <th class="forumtitle">{L_SELECT}</th>
        </tr>
        <tr> 
          <td class="menu" colspan="8" height="28"><span class="cattitle">{L_GROUP_MODERATOR}</span></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td class="menu" colspan="8" height="28"><span class="cattitle">{L_GROUP_MEMBERS}</span></td>
        </tr>
        <!-- BEGIN member_row -->
        <tr> 
        ...
        <!-- BEGIN switch_mod_option -->
        <tr>
                <td class="menu" colspan="8" align="right"><span class="cattitle">
