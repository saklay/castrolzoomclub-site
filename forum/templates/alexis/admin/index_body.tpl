...
<p><font size="+1"><b>alexis theme v1.0 information</b></a></p>
<p>Welcome to alexis theme, version 1.0. This theme was created by <a href="http://andrewcharron.tk">Andrew Charron</a>,  inspired by the CD case of <a href="http://theonlybandever.com">alexisonfire</a>. Support for this theme can currently be found at <a href="http://www.dosgames.com/~kazer0/alexis/">the support forum</a>. Unfortunately, you'll have to live with the funky looking Admin Panel. I recommend you use SubSilvers Admin panel. Watch for version 1.5 and 2.0 of alexis, as well as diffrent colors of it. Thanks for using alexis,</p><p align="right">- Andrew Charron</p>
<h1>{L_FORUM_STATS}</h1>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <!-- END reg_user_row -->
  <tr> 
        <td colspan="5" height="1" class="row3"><img src="../templates/alexis/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
