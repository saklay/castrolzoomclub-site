...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumborder">
        <tr> 
                <th class="forumtitle" colspan="2" height="25"><b>{L_SEND_EMAIL_MSG}</b></th>
        </tr>
        <tr> 
        ...
        <tr>
                <td class="menu" colspan="2" align="center" height="28">{S_HIDDEN_FIELDS}<input type="submit" tabindex="6" name="submit" class="mainoption" value="{L_SEND_EMAIL}" /></td>
        </tr>
</table>
