...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumborder">
  ...
  <tr> 
        <th colspan="2" align="center" class="forumtitle" height="25">{L_GROUP_MEMBERSHIP_DETAILS}</th>
  </tr>
  ...
  <tr> 
        <th colspan="2" align="center" class="forumtitle" height="25">{L_JOIN_A_GROUP}</th>
  </tr>
  <tr> 
