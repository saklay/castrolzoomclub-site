 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://www.castrolzoomclub.com/phpmyadmin/';
...
$cfg['Servers'][$i]['user']          = 'castrolz_admin';      // MySQL user
$cfg['Servers'][$i]['password']      = 'admin';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'castrolz_sitedb';          // If set to a db-name, only
...
$cfg['Servers'][$i]['user']            = 'castrolz_admin';
$cfg['Servers'][$i]['password']        = 'admin';
$cfg['Servers'][$i]['only_db']         = 'castrolz_sitedb';
